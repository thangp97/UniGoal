...
//public class CountdownTimerController {
//    private JLabel countdownLabel, daysLabel, hoursLabel, minutesLabel, secondsLabel;
//
//    public CountdownTimerController() {
...
//
//        JPanel timerPanel = new JPanel(new GridLayout(1, 4, 20, 0)); // 4 cột
//        countdownPanel.setBackground(new Color(20, 30, 48)); // Cùng màu nền
//        countdownPanel.add(timerPanel, BorderLayout.CENTER);
//
//        daysLabel = createTimeLabel("Ngày");
//        hoursLabel = createTimeLabel("Giờ");
//        minutesLabel = createTimeLabel("Phút");
//        secondsLabel = createTimeLabel("Giây");
//
//        countdownPanel.add(createCountdownPanel(daysLabel, "Ngày"));
//        countdownPanel.add(createCountdownPanel(hoursLabel, "Giờ"));
//        countdownPanel.add(createCountdownPanel(minutesLabel, "Phút"));
...
//
//    private void initializeTimer() {
//        Timer timer = new Timer(1000, e -> updateCountdown(daysLabel, hoursLabel, minutesLabel, secondsLabel));
//        timer.start();
//    }
//
//    private static JLabel createTimeLabel(String text) {
//        JLabel label = new JLabel("00", SwingConstants.CENTER);
//        label.setFont(new Font("Arial", Font.BOLD, 36));
//        label.setForeground(Color.WHITE);
//        return label;
//    }
//
//    private static JPanel createCountdownPanel(JLabel timeLabel, String unitText) {
//        JPanel panel = new JPanel(new BorderLayout());
//        panel.setBackground(new Color(44, 62, 80)); // Màu tối hơn cho khối
//        panel.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10));
//
...
//    }
//
//    private static void updateCountdown(JLabel daysLabel, JLabel hoursLabel, JLabel minutesLabel, JLabel secondsLabel) {
//        try {
//            String examDateTime = "2025-06-01T08:00:00"; // Thời gian thi
//            LocalDateTime now = LocalDateTime.now();
//            LocalDateTime examTime = LocalDateTime.parse(examDateTime);
