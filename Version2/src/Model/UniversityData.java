...
//
//import Version2.src.Controller.UniversitySearchUI;
//
//import javax.swing.*;
...
//            }
//            UniversitySearchUI.NonEditableTableModel model = new UniversitySearchUI.NonEditableTableModel(
//                    dataArray, new String[]{"Mã Trường", "Tên Trường", "Điểm Sàn"}
//            );
//            table.setModel(model);
//
//            // Thêm sắp xếp cho bảng
//            TableRowSorter<UniversitySearchUI.NonEditableTableModel> sorter = new TableRowSorter<>(model);
